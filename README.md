...
-The script called rdfgpu4.py is the slower or both because this one expects varying cells, this one is for RDF done on similar estructures frames with varying cells or lattice parameters
